class PiecesController < ApplicationController
  ...
  def new
    @piece = Piece.new
    # Preseleccionar el dice_id si viene en los parámetros
    @piece.dice_id = params[:dice_id] if params[:dice_id].present?
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to pieces_path, status: :see_other, notice: "Piece was successfully destroyed." }
  ...
  private
    ...
    def piece_params
      params.require(:piece).permit(:code, :strikes, :dice_id)  # Incluye dice_id aquí
    end
end
